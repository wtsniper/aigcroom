...
export const FEATURED_GUIDE_SLUGS = [
  ...
  'ai-video-generators-compared-2026-complete-guide',
  'luma-vs-runway-vs-kling-2024',
  'higgsfield-ai-shorts-beginners-guide-2026',
  'seedance-2-access-guide-2026',
  'faceless-ai-youtube-channel-guide-2026',
  'openai-anthropic-ipo-2026-what-it-means',
  'chatgpt-florida-lawsuit-ai-liability-2026',
  'apple-siri-ai-wwdc-2026-gemini-explained',
  'gemini-omni-flash-youtube-shorts-2026-guide',
  'openai-codex-5-million-weekly-users-2026',
  'google-antigravity-2-agent-platform-2026-guide',
  'seedance-2-5-announced-2026-guide',
  'kling-3-0-turbo-2026-guide',
  'paperclip-heart-ai-short-film-2026',
  'kling-korean-baseball-ai-trend-2026',
